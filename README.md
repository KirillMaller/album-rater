...
React/Vite сайт-каталог оценок стримера **R1Fmabes**: альбомы, треки, баттлы, реакции. В будущем — голосование зрителей с лёгким логином.

## Быстрый контекст

R1Fmabes стримит на YouTube / Twitch / Boosty: баттл-рэп, реакции, обзоры альбомов, фильмы и аниме по донатам. Сайт — каталог его оценок в одном месте плюс задел под зрительское голосование.
