...
`.cringe`, `.cringe__pic`, `.cringe__text` — уголок с ерундой на экране
ноутбука, меняется каждый раунд. Раньше там висел QR-код; во время игры он
не нужен, гости сканируют его один раз в лобби.
