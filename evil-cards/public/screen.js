...
const CRINGE = [
  ['🍺', 'балтика девятка не предлагать'],
  ['🥟', 'эчпочмак не для слабых'],
  ['🚬', 'вышел покурить, вернулся другим человеком'],
  ['🧃', 'это не сок'],
  ['🛴', 'приехал на самокате, уехал на скорой'],
  ['🪳', 'таракан платит за аренду, а ты нет'],
  ['💊', 'топтыжка внутривенно'],
  ['🧻', 'утро будет тяжёлым'],
  ['🎣', 'закинул удочку в общую беседу'],
  ['🚕', '1700 до дома и ни рубля меньше'],
  ['🧦', 'мокрый носок передаёт привет'],
  ['📉', 'мама опять сказала что я конченый'],
  ['🍉', 'арбуз арбуз'],
  ['🦷', 'зуб даю (не свой)'],
  ['🛒', 'пятёрочка знает обо мне всё'],
  ['🧊', 'лёд закончился, совесть тоже'],
  ['🪦', 'здесь могла быть твоя курсовая'],
  ['📞', 'голосовое на восемь минут'],
  ['🧠', 'нормисы не поймут'],
  ['🐟', 'рыба моей мечты'],
];
