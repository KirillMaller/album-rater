...
- **Период:** 2026-05-27 (один день, ~15 часов работы).
...
- **Статус спринта:** ✅ закрыт по P0/P1. Оставшиеся пункты (16 «Удаление аккаунта», 17 «Supabase Auth прокси», 18 «Уведомление РКН», 19 «Локализация ПДн») перенесены в [BACKLOG.md](../../docs/BACKLOG.md) → P3, к ним вернёмся когда сайт получит первую сотню зрителей.
...
| 15 | **UI голосования за баттл** — выбор победителя итога + цифровая оценка баттла зрителями | 🟠 P1 | ✅ выполнено 2026-05-27 **(120 мин)** — BattleVoteBlock с агрегатом %, AlbumVotePanel также работает для type=battle, методы saveMyBattleRound/Final |
| 29 | **Hero на странице записи** — две капсулы R1F + Зрители рядом, переставлены строки | 🟡 P2 | ✅ выполнено 2026-05-27 **(30 мин)** — `detail-hero-scores` + новый порядок eyebrow/h1/scores/best-tracks/meta |
...
| 19 | **Локализация ПДн в РФ** (152-ФЗ ст. 18.5) | 🟢 P3 | 🛑 перенесено в [BACKLOG → P3](../../docs/BACKLOG.md) |
